...
while True:
    ...
    a_upper = cv2.getTrackbarPos("A_upper", window_name)
    a_lower = cv2.getTrackbarPos("A_lower", window_name)
    b_upper = cv2.getTrackbarPos("B_upper", window_name)
    b_lower = cv2.getTrackbarPos("B_lower", window_name)
