...
class TrackHumanFinger(object): # TODO
    ...
    def __init__(self, video_name=[],denoising_mode='monocolor'): # TODO
        ...
        if self.color_mode ==0: # Lab
            self.maker_tolerance_L = [20,15,15,10,8]#int(0.08 * 255)
            self.maker_tolerance_a = [20,15,15,15,15]# int(0.09 * 255)# red -> green
            self.maker_tolerance_b = [20,15,15,15,15]# int(0.09 * 255)# Yellow -> Blue
        else : # RGB
    ...
    def extract_angle(self, frame, swap, colors):
        ...
        [marker_blue, marker_pink, marker_green, marker_yellow, marker_brown] = self.segment_marker_by_color(cielab_frame)
        ...
        masks = np.stack([marker_blue, marker_pink, marker_green, marker_yellow, marker_brown], axis=0)
        ...
        if 1:
            ...
            for mask, thr, color, color_name,  color_num in zip(masks, threshold_area_size, colors, colors_name, [0,1,2,3,4]):
                ...
                # print('pointpermask', point_per_mask)
                # print('markersetperframe', makerset_per_frame)
...
if __name__ == '__main__':
    ...
    try:
        while True:
            ...
            print('self.markerrangers', tracker.marker_rangers)
