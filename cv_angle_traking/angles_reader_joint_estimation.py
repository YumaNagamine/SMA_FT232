...
class AngleTracker(object): # TODO
    ...
    def __init__(self, video_name=[],denoising_mode='monocolor'): # TODO
        ...
        self.colors = [(0,127,0), (127,0,255), (255,0,0)] #,(0,127,255)]

        if self.color_mode ==0: # Lab
            self.marker_tolerance_L = [75,50,20] #,20]#int(0.08 * 255)
            self.marker_tolerance_a = [30,45,17] # ,17]# int(0.09 * 255)# red -> green
            self.marker_tolerance_b = [40,20,15] #,30]# int(0.09 * 255)# Yellow -> Blue
        else : # RGB
    ...
    def segment_marker_by_color_Maros(self,frame_tmp):
        ...
        for i in range(num_marker_sets):
    ...
    def extract_angle(self, frame, whether_firstframe):
        ...
        # masks = np.stack([marker_blue, marker_pink, marker_green], axis=0)
        ...
        if 1:
            ...
            cv2.line(frame, metacarpal[0], metacarpal[1],(0,127,255),3)
