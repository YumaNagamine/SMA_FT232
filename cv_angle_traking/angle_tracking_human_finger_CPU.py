...
class TrackHumanFinger(object): # TODO
    ...
    def mouse_event(self,event, x, y, flags, param):
        ...
        return []
    def segment_marker_by_color_cpu(self, frame): # by nagamine, including cvtcolor process!
        ...
        for rng in self.marker_rangers:  
            ...
            mask = cv2.inRange(cielab_frame, lowerb, upperb)
    ...
    def extract_angle(self, frame, swap, colors):
        ...
        masks = self.segment_marker_by_color_cpu(frame)
